(() => {
  ...
  function reset() {
    ...
    digit.src = "./img/display-digit-1.svg";
    startTimer()
  }
  ...
  function setTime(duration) {
    ...
    timer0.src = `./img/display-digit-${secondString[0]}.svg`;
    timer1.src = `./img/display-digit-${secondString[1]}.svg`;
    timer2.src = `./img/display-digit-${secondString[2]}.svg`;
  }
  ...
  oneSquare.addEventListener("mouseup", (e) => {
    ...
    if(e.ctrlKey || e.which === 3) {
      ...
      digit.src = "./img/display-digit-0.svg";
    } else {
      faceButton.classList.remove("face-button-clicking");
